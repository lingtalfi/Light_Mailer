...
Source Code
===========
See the source code for method [LightMailerService::checkSubject](https://github.com/lingtalfi/Light_Mailer/blob/master/Service/LightMailerService.php#L605-L613)
